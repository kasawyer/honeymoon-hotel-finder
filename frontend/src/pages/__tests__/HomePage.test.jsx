...
describe("HomePage", () => {
  ...
  it("navigates to results when a popular destination is clicked", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith(expect.stringContaining("location=Maldives"));
  });
  ...
  it("navigates to results when search is submitted", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith(expect.stringContaining("location=Bora+Bora"));
  });
  ...
  it("includes selected keywords in navigation URL", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith(expect.stringContaining("keywords="));
  });
});
