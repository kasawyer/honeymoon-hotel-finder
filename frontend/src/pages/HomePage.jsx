        ...
        <div className="flex flex-col items-center px-4">
            ...
            <div className="text-center mt-16 sm:mt-24 mb-10 max-w-2xl">
                ...
                <p className="text-lg" style={{ color: "var(--color-text-light)" }}>
                    Search across Booking.com, TripAdvisor, Expedia & Google to find
                    the most romantic stays for your special trip.
                </p>
            </div>
            ...
            <div className="mt-16 mb-20 w-full max-w-2xl">
                <h2 className="text-sm font-semibold text-center mb-4" style={{ color: "var(--color-text-muted)" }}>
